      ...
      <div className="footer-container">
        ...
        <div className="footer-main">
          ...
          <div className="footer-column">
            ...
            <p className="footer-about-text">
              The City University Library serves as the academic hub of our institution, 
          ...
          <div className="footer-column">
            ...
            <ul className="footer-contact-info">
              <li className="contact-item">
                ...
                <span>Khagan, Birulia, Savar, Dhaka-1340, Bangladesh</span>
              </li>
              <li className="contact-item">
                <FiMail className="contact-icon" />
                <span>library@cityuniversity.ac.bd</span>
              </li>
              <li className="contact-item">
                <FiPhone className="contact-icon" />
                <span>Cell: +8801322917670</span>
              </li>
              <li className="contact-item">
        ...
        <div className="footer-bottom">
          <div className="footer-copyright">
            &copy; {new Date().getFullYear()} City University Library. All rights reserved.
          </div>
